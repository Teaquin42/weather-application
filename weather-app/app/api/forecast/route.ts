...
export async function GET(req: NextRequest) {
    ...
    const url = isPostcode? `https://api.openweathermap.org/data/2.5/forecast?zip=${trimmedLocation},GB&appid=${apiKey}`
    : `https://api.openweathermap.org/data/2.5/forecast?q=${encodeURIComponent(trimmedLocation)}&appid=${apiKey}`;
